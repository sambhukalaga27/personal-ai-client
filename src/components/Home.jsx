  ...
  return (
    <div className="home-page">
        ...
        <div className="container">
          ...
          <div className="developer-content">
            <div className="developer-intro">
              <h3>Sai Sambhu Prasad Kalaga</h3>
              <p className="developer-role">Data Scientist, AI/ML Engineer</p>
              <p className="developer-description">
                MS in Computer Science Graduate (SMU, Dallas, Texas) with expertise in Full Stack Development, AI and Machine Learning.
            ...
            <div className="developer-links">
              <button
                ...
                onClick={() => window.open('https://github.com/sambhukalaga27', '_blank')}
              >
              ...
              <button
                className="dev-link-btn"
                onClick={() => window.open('https://www.linkedin.com/in/sai-sambhu-prasad-kalaga/', '_blank')}
              >
                <svg viewBox="0 0 24 24" fill="currentColor">
      ...
      <footer className="footer">
        <div className="container">
          <p>&copy; {new Date().getFullYear()} Personal AI. Developed by <strong>Sai Sambhu Prasad Kalaga</strong></p>
        </div>
      </footer>
    </div>
  );
